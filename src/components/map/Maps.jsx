...
//   const [floodLevel, setFloodLevel] = useState(0);
//   const [drainageHoles, setDrainageHoles] = useState([]);
//   const [isRaisingWater, setIsRaisingWater] = useState(false);
...
// Make sure this path matches where Cesium is hosted
// If using create-react-app, you may need to copy static Cesium assets to public folder
...
export default function CesiumViewer() {
  ...
  useEffect(() => {
    ...
    Cesium.Cesium3DTileset.fromIonAssetId(3048665)
      .then((tileset) => {
