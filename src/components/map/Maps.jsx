...
const EnhancedIslandSystem = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-blue-900 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-gray-900 bg-opacity-90 text-white p-4 rounded-lg z-[999] max-w-[380px] border border-blue-600">
